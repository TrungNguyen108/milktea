...
class PdfParagraphApi {
  static Future<File> generate() async {
    final pdf = Document();
    final customFont = Font.ttf(await rootBundle.load('assets/fonts/OpenSans-Regular.ttf'));
    pdf.addPage(
      MultiPage(
        build: (context) => <Widget>[
          ...
          Paragraph(
            text:'This is my custom font that displays also characters such as €, Ł, ...',
  ...
  static Widget buildCustomHeader() => Container(
    ...
    child: Row(
      children: [
        ...
        Text('Create Your PDF',style: TextStyle(fontSize: 20, color: PdfColors.blue),),
      ],
    ),
  );

  static Widget buildCustomHeadline() => Header(
    child: Text('My Third Headline',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold,color: PdfColors.white,),),
  ...
  static Widget buildLink() => UrlLink(
    ...
    child: Text('Go to flutter.dev',style: TextStyle(decoration: TextDecoration.underline,color: PdfColors.blue,),),
  );
